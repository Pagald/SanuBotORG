...
async def start(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 Req to Join Updates Channel", url=invite_link.invite_link
                )
            ]
        ]
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/movi_wa')
                            ]
                        ]
                    )
                    )
    ...
    # button = InlineKeyboardButton('▶ Gen Stream / Download Limovi_wank', callback_data=f'generate_stream_link:{file_id}')
    button = InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/movi_wa')
...
async def plan(client, message):
    ...
    await message.reply_photo(photo="https://graph.org/file/55a5392f88ec5a4bd3379.jpg", caption=script.PLANS_TXT.format(users), reply_markup=InlineKeyboardMarkup(btn))
